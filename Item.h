...
class Item {
  public:
    ...
    Item();
    void ItemVariable(string var_category, string var_name, string var_type, string var_dimension);
    void ItemParam(string var_category, string var_name, string var_type, string var_dimension);
